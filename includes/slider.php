<div class="container shadow-lg mt-3 p-2 rounded">
    ...
    <div class="row pt-2">
        <div class="col-md-12">
            <div class="card-text text-center">
                <h3><span class="text-danger">ข่าวประชาสัมพันธ์</span>วท.ตราด</h3>
            </div>
        </div>
    </div>
    ...
    <div class="row pt-3">
        <div class="col-md-12">
            <div class="card-text text-center">
                <h3><span class="text-warning">"เทคนิคตราดโฉมใหม่ ใส่ใจบุตรหลาน จัดการศึกษา เพื่อการมีงานทำ"</span>วท.ตราด</h3>
            </div>
        </div>
    </div>
